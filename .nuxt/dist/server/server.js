...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vuex_module_decorators__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
...
__decorate([vuex_module_decorators__WEBPACK_IMPORTED_MODULE_0__["Mutation"]], User.prototype, "updateUserInfo", null);

User = __decorate([Object(vuex_module_decorators__WEBPACK_IMPORTED_MODULE_0__["Module"])({
  stateFactory: true,
  namespaced: true
})], User);
...
const _29be480c = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 29))); // TODO: remove in Nuxt 3
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(26), 'user.ts'); // If the environment supports hot reloading...
})(); // createStore
...
/* harmony default export */ var plugins_axios = (({
  ...
  $axios.onError(error => {// console.log('onError')
  });
  console.log('$axios');
...
// CONCATENATED MODULE: ./plugins/testPlugin.ts
/* harmony default export */ var testPlugin = (({
  app,
  store
}, inject) => {
  let wrap = null;
...
/* Plugins */
 ...
 // Source: ../plugins/testPlugin (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof testPlugin === 'function') {
    await testPlugin(app.context, inject);
